...
class FP_RecordController extends Controller
{
    ...
    public function store(Request $request) {
        $request->validate([
            'import-file' => 'required|file|mimes:csv,txt',
            'age' => 'required'
        ]);
        ...
        // Set skipFirstRow to true if the extension is 'csv'
        $skipFirstRow = strtolower($extension) === 'csv';
        ...
        foreach ($fileContents as $line) {
            if ($skipFirstRow) {
                $skipFirstRow = false; // After skipping, set the flag to false
