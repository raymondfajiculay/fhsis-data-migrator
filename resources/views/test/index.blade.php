<x-layout>
    <h2 class="text-3xl font-bold tracking-tight text-gray-900 text-center">FP Record Migrator Test Site</h2>
    <div class="flex items-center justify-center p-5">
        <div class="mx-auto w-full max-w-[550px] bg-white">
            <form class="py-6 px-9" action="{{route('test')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
